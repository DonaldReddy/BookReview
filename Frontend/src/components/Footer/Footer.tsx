...
const Footer: React.FC = () => {
  return (
    <footer className="w-full px-4 py-8">
      <div className="max-w-5xl mx-auto rounded-2xl bg-gray-100 dark:bg-gray-600 shadow-md p-6 text-gray-600 dark:text-gray-100">
        {/* Grid Layout */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12 divide-y md:divide-y-0 md:divide-x divide-gray-300 dark:divide-gray-500">
          ...
          <div className="flex justify-center md:justify-start">
            <img src={spark} alt="spark" className="w-8 h-8 mb-2" />
            </div>
          ...
          <div className="space-y-2 md:pl-6 pt-6 md:pt-0">
            ...
            <p className="text-sm">
              <a href="https://donaldreddy.xyz" target="_blank" rel="noopener noreferrer" className="hover:underline">
                Donald Reddy
              </a>
            </p>
            <div className="flex space-x-4 mt-2">
              <a href="https://github.com/DonaldReddy" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
                <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/github/github-original.svg" alt="GitHub" className="w-5 h-5" />
              </a>
              <a href="https://www.linkedin.com/in/donald-reddy-indelu/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
