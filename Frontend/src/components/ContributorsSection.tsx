...
const ContributorsSection: React.FC = () => {
  ...
  return (
    <section className="bg-gray-100 dark:bg-gray-900 py-10 px-4 md:px-6">
      {/* ✅ External Container */}
      <div className="max-w-5xl mx-auto text-center rounded-2xl p-6 shadow-lg 
        ...
        <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3">
          {currentContributors.map((contributor) => (
            ...
            >
              ...
              />
              <h3 className="text-base font-semibold text-gray-800 dark:text-white">{contributor.login}</h3>
              <p className="text-xs text-gray-500 dark:text-gray-300">GitHub Contributor</p>
            </div>
          ))}
        </div>
