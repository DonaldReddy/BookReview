...
export default function NavBar() {
  ...
  return (
    <div
      className={`p-2 max-w-screen-2xl fixed top-0 left-0 right-0 z-100 backdrop-blur-md bg-blue-100/40 dark:bg-black/30 shadow-sm transform transition-transform duration-300 ${
