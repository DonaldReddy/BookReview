...
const AboutUs: React.FC = () => {
    ...
    return (
        <div
            className="min-h-screen w-full bg-gradient-to-br from-sky-100 via-indigo-200 to-violet-200 
        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        — a collaborative open-source platform for book lovers!
                        Whether you're a curious reader, techie, or open-source
                        contributor, we empower you to explore books, share
                        reviews, and grow with a passionate community.
                    </motion.p>
                </motion.div>
            </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-10 mb-20">
                ...
                <motion.div
                    ...
                    onClick={() =>
                        handleOpenPopup(
                            "🌐 Our Motto",
                            "Read. Contribute. Connect — open learning through books & tech."
                        )
                    }
                ...
                >
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                        <strong>"Read. Contribute. Connect."</strong> — We
                        believe in open learning, shared ideas, and global
                ...
                <motion.div
                    ...
                    onClick={() =>
                        handleOpenPopup(
                            "🔧 Open Source",
                            "Explore, suggest features, and contribute to BookReview.in open-source community."
                        )
                    }
                    className="mt-16 cursor-pointer rounded-2xl bg-white dark:bg-gray-800 p-6 shadow-md hover:shadow-2xl 
                     hover:border-blue-500 hover:bg-blue-50 dark:hover:bg-gray-700 border border-gray-200 dark:border-gray-700 
                ...
                >
                    ...
                    <p className="text-gray-600 dark:text-gray-300 mb-4">
                        BookReview.in is proudly open-source. Explore the code,
                        suggest features, raise issues, or submit pull requests
                        — every line of contribution counts.
                    </p>
                    <a
            ...
            >
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-6 max-w-xl mx-auto">
                    A big thanks to all the amazing individuals who’ve helped
                    shape BookReview.in into what it is today.
                </p>
